...
itemList: typing.List[ItemData] = [
    ...
    ItemData(0x06, "Ultra Nuts", ItemClassification.filler, 0x10),
    ...
    ItemData(0x0A, "Ultra Syrup", ItemClassification.filler, 0x14),
    ItemData(0x0B, "Max Syrup", ItemClassification.filler, 0x15),
    ItemData(0x0C, "1-UP Mushroom", ItemClassification.useful, 0x16),
    ItemData(0x0D, "1-UP Super", ItemClassification.useful, 0x17),
    ItemData(0x0E, "Golden Mushroom", ItemClassification.filler, 0x18),
    ...
    ItemData(0x40, "Beanlet 1", ItemClassification.filler, 0x73),
    ItemData(0x41, "Beanlet 2", ItemClassification.filler, 0x74),
    ItemData(0x42, "Beanlet 3", ItemClassification.filler, 0x75),
    ItemData(0x43, "Beanlet 4", ItemClassification.filler, 0x76),
    ItemData(0x44, "Beanlet 5", ItemClassification.filler, 0x77),
    ItemData(0x45, "Beanstone 1", ItemClassification.filler, 0x80),
    ItemData(0x46, "Beanstone 2", ItemClassification.filler, 0x81),
    ItemData(0x47, "Beanstone 3", ItemClassification.filler, 0x82),
    ItemData(0x48, "Beanstone 4", ItemClassification.filler, 0x83),
    ItemData(0x49, "Beanstone 5", ItemClassification.filler, 0x84),
    ItemData(0x4A, "Beanstone 6", ItemClassification.filler, 0x85),
    ItemData(0x4B, "Beanstone 7", ItemClassification.filler, 0x86),
    ItemData(0x4C, "Beanstone 8", ItemClassification.filler, 0x87),
    ItemData(0x4D, "Beanstone 9", ItemClassification.filler, 0x90),
    ItemData(0x4E, "Beanstone 10", ItemClassification.filler, 0x91),
